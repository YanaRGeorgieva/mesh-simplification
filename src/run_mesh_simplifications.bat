...
set PYTHON_SCRIPT=src\simplify_meshes_cli.py
...
REM Define the lists of threshold, ratio, and penalty_weight values 0.0 0.1 0.3
set THRESHOLDS=0.0 0.1 0.3
set RATIOS=0.9 0.5 0.3
set PENALTIES=2000
